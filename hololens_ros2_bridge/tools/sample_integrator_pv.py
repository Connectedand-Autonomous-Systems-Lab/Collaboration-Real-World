...
class depth_client:
    def __init__(self):
        ...
        self.scale = None
        self.thread = threading.Thread(target=self.run_longthrow_integration)
        self.thread.start()

    def get_depth(self):
        return self.depth

    def run_longthrow_integration(self):
        # Keyboard events ---------------------------------------------------------
        ...
        self.undistort_map = calibration_lt.undistort_map
        self.intrinsics = calibration_lt.intrinsics
