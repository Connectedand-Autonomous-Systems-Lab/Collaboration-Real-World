    ...
    tests_require=['pytest'],
        entry_points={
            'console_scripts': [
                ...
                'depth_camerainfo_parser = hololens_ros2_bridge.depth_camerainfo_parser:main',
                'image_saver = hololens_ros2_bridge.image_saver_node:main',
                'odom_publisher = hololens_ros2_bridge.odom_publisher:main',
                'tb4_basic_monitor = hololens_ros2_bridge.tb4_basic_monitor:main',
            ],
        },
    )
